        ...
        switch (item.getItemId()) {
            case CONTEXT_MENU_DELETE:
                ...
                if(((String)listGroup.get(posGroup).groupInfo.get("admin")).equals(StaticConfig.UID)) {
                    ...
                    Toast.makeText(getActivity(), "No eres administrador", Toast.LENGTH_LONG).show();
                }
                break;
            case CONTEXT_MENU_EDIT:
                ...
                if(((String)listGroup.get(posGroup1).groupInfo.get("admin")).equals(StaticConfig.UID)) {
                    ...
                    Toast.makeText(getActivity(), "No eres admin", Toast.LENGTH_LONG).show();
                }
            ...
            case CONTEXT_MENU_LEAVE:
                ...
                if(((String)listGroup.get(position).groupInfo.get("admin")).equals(StaticConfig.UID)) {
                    Toast.makeText(getActivity(), "Los administradores no pueden dejar el grupo :O", Toast.LENGTH_LONG).show();
                }else{
            ...
            FirebaseDatabase.getInstance().getReference().child("group/"+group.id).removeValue()
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            adapter.notifyDataSetChanged();
                            Toast.makeText(getContext(), "Eliminar grupo", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            new LovelyInfoDialog(getContext())
                                    ...
                                    .setIcon(R.drawable.ic_dialog_delete_group)
                                    .setTitle("UPS")
                                    .setMessage("No se puede eliminar en este momento")
                                    .setCancelable(false)
...
class ItemGroupViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
        ...
        menu.add(Menu.NONE, GroupFragment.CONTEXT_MENU_EDIT, Menu.NONE, "Editar groupo").setIntent(data);
        menu.add(Menu.NONE, GroupFragment.CONTEXT_MENU_DELETE, Menu.NONE, "Eliminar groupo").setIntent(data);
        menu.add(Menu.NONE, GroupFragment.CONTEXT_MENU_LEAVE, Menu.NONE, "Dejar groupo").setIntent(data);
    }
}