...
public class LoginActivity extends AppCompatActivity {
    ...
    public void clickLogin(View view) {
        ...
        if (validate(username, password)) {
            ...
            Toast.makeText(this, "Email invalido o contraseña vacia", Toast.LENGTH_SHORT).show();
        }
    }
                            ...
                            if (!task.isSuccessful()) {
                                new LovelyInfoDialog(LoginActivity.this) {
                                    ...
                                    public LovelyInfoDialog setConfirmButtonText(String text) {
                                        ...
                                        .setTitle("UPS")
                                        .setMessage("Email existente o contraseña debil!")
                                        .setConfirmButtonText("ok")
                                        .setCancelable(false)
                                        .show();
                            } else {
                                initNewUserInfo();
                                Toast.makeText(LoginActivity.this, "Registro e ingreso exitoso :)", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(LoginActivity.this, MainActivity.class));
                                LoginActivity.this.finish();
                            }
                        }
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                new LovelyInfoDialog(LoginActivity.this) {
                                    ...
                                    public LovelyInfoDialog setConfirmButtonText(String text) {
                                        ...
                                        .setTitle("UPS")
                                        .setMessage("El usuario no existe o la contraseña esta mal! :(")
                                        .setCancelable(false)
                                        .setConfirmButtonText("Ok")
                                        .show();
                            } else {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            new LovelyInfoDialog(LoginActivity.this) {
                                ...
                                public LovelyInfoDialog setConfirmButtonText(String text) {
                                    ...
                                    .setMessage("Enviaremos un mensaje a " + email)
                                    .setConfirmButtonText("Ok")
                                    .show();
                        }
                    })
                ...
                public void onFailure(@NonNull Exception e) {
                    new LovelyInfoDialog(LoginActivity.this) {
                        ...
                        public LovelyInfoDialog setConfirmButtonText(String text) {
                            ...
                            .setIcon(R.drawable.ic_pass_reset)
                            .setTitle(";(")
                            .setMessage("No se ha podido enviar el mensaje a " + email)
                            .setConfirmButtonText("Ok")
                            .show();
                }
            });
